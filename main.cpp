...
const int Nr = 10; // 128位密钥的aes加密需要加密10轮
const int Nk = 4; // 输入密钥的字数（一个字数是32位）
 ...
 * @return
 */
word byte_to_word(byte& k1, byte& k2, byte& k3, byte& k4){
